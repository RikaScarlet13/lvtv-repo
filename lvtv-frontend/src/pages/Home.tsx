    ...
    <div className="px-10">
      <div className="divide-y-8 divide-yellow-400 px-10 text-white">
        <div className="flex justify-center mx-auto p-20">
          ...
          <div className="mx-auto flex rounded-sm w-1/2 h-96 bg-white shadow p-20 hover:shadow-lg"></div>
        </div>
        <div className="p-20 flex justify-center">
          <div>
            <h1 className="text-2xl">About LV.tv</h1>
            <br />
        ...
        <div className="flex justify-center mx-auto p-10">
          <div className="mx-auto flex justify-center flex-col space-y-4">
            <h1 className="text-2xl">Schedules & Programs</h1>
            <br />
